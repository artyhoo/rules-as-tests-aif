...
// Playwright configuration for React SPA (Vite) projects.
// Covers end-to-end tests in real browsers.
//
...
export default defineConfig({
  ...
  // Local Vite dev server (skipped in CI — assume separate build job)
