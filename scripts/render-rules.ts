...
const manifest: Manifest = JSON.parse(
  readFileSync(resolve(ROOT, 'factory/rules-manifest.json'), 'utf8'),
);
const schema = JSON.parse(
  readFileSync(resolve(ROOT, 'factory/rules-manifest.schema.json'), 'utf8'),
);
...
const targetPath = resolve(ROOT, 'factory/RULES.md');
