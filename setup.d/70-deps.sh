#!/usr/bin/env bash
# setup.d/70-deps.sh — §7 package scripts (1256-1338) + §8 dev-dep install (1340-1418)
#                      + §8b tsx-at-root (1420-1475)
# Source: install.sh §7 lines 1256-1338, §8 lines 1340-1418, §8b lines 1420-1475
# Globals consumed: FORCE, DRY_RUN, SKIPPED, PKG_ROOT, PROJECT_ROOT, STACK, FULL
# Globals set: DEPS_INSTALLED, DEVDEPS (read by 99-finalize.sh)
